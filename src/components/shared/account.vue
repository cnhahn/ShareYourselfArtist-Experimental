  ...
  export default {
    data() {
      return {
        ...
        plans: [{title: "Local Plan", credit: "25 credits/month", price: "$10 Monthly"},
          {title: "Professional Plan", credit: "70 credits/month", price: "$20 Monthly"},
          {title: "Art Agent Plan", credit: "210 credits/month", price: "$50 Monthly"},
