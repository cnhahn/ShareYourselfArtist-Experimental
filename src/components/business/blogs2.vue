...
<v-container>
    ...
    <h6 class="headline mb-4" style="font-weight: bold; color: black !important">Submit to Blogs</h6>
    ...
    <v-layout row wrap v-for="(blog, index) in user_info" v-bind:key="blog.url" v-if="!screen_breakpoint">
      ...
      <v-flex>
        ...
        <v-btn
            v-if="user_role === 'artist' && !blog.selected"
            color="primary"
            thin
           ...
           <v-btn
            ...
            class="white--text elevation-0"
            style="margin-top: -10px; margin-left: 0px"
            @click='remove_a_business(blog.email, index)'>UNSELECT BLOG
          </v-btn>
    ...
    <v-layout row wrap v-for="(blog, index) in user_info" v-bind:key="blog.url" v-if="screen_breakpoint">
      ...
      <v-flex lg3 md3 sm4>
        ...
        <v-btn
            ...
            color="primary"
            thin
            class="hidden-sm-and-down white--text elevation-0"
            style="margin-top: -10px; margin-left: 0px"
            @click='add_a_business({
            userId: blog.userId,
            business_email: blog.email,
        ...
        <v-btn
            ...
            color="primary"
            thin
            class="hidden-md-and-up white--text elevation-0"
            style="margin-top: -10px; margin-left: 0px"
            @click='add_a_business({
            userId: blog.userId,
            business_email: blog.email,
    ...
    <div v-if="$store.getters.businesses_being_submitted.length != 0">
      <h6 class="headline mb-1" style="font-weight: bold; color: black !important">Selected Blogs:</h6>
      <p class="body-1" style="margin-bottom: 5px" v-for="blog in this.$store.getters.businesses_being_submitted" v-bind:key="blog.business_name">
        <span>{{blog.business_name}}</span>
      </p>
      <v-btn
          lg12 text-lg-right mb-5  
          color="red"
  ...
  export default {
    data() {
      return {
        ...
        business_name:'',
        select_business:[],
        business_list_to_submit: this.$store.getters.businesses_being_submitted
      }
    },
    computed: {
      user_role() {
