...
export const store = new Vuex.Store({
         ...
         mutations: {
           ...
           set_monthly_report_month(state, payload) {
             state.monthly_report_chosen_month = payload;
           },
         ...
         actions: {
           // for report
           goto_dash2({ commit, getters }) {
             console.log("goto dash called");
           ...
           report_aug({ commit, getters }, payload) {
             ...
             let query = temp_report
               .where(
                 "businessId.business_email",
                 "==",
                 payload.business_email
               )
               .where("replied_date", ">", 1533081600000)
               .where("replied_date", "<", 1535760000000);
             query
               .get()
               .then(function(results) {
                 if (results.empty) {
                   ...
                   results.forEach(function(doc) {
                     commit(
                       "set_replied_requests_for_report_aug",
                       doc.data()
                     );
                   });
                   // set_replied_requests_for_report
           ...
           report_sep({ commit, getters }, payload) {
             ...
             let query = temp_report
               ...
               .where("replied_date", ">", 1537488000000)
               .where("replied_date", "<", 1538870400000);
             query
               .get()
               .then(function(results) {
                 if (results.empty) {
                   ...
                   results.forEach(function(doc) {
                     commit(
                       "set_replied_requests_for_report_sep",
                       doc.data()
                     );
                   });
                   // set_replied_requests_for_report
           ...
           report_oct({ commit, getters }, payload) {
             ...
             let query = temp_report
               ...
               .where("replied_date", ">", 1535760000000)
               .where("replied_date", "<", 1538352000000);
             query
               .get()
               .then(function(results) {
                 if (results.empty) {
                   ...
                   results.forEach(function(doc) {
                     commit(
                       "set_replied_requests_for_report_oct",
                       doc.data()
                     );
                   });
                   // set_replied_requests_for_report
             ...
             query
               ...
               .then(function(results) {
                 if (results.empty) {
                   ...
                   results.forEach(function(doc) {
                     commit(
                       "set_replied_requests_for_report_nov",
                       doc.data()
                     );
                   });
                   // set_replied_requests_for_report
             ...
             query
               ...
               .then(function(results) {
                 if (results.empty) {
                   ...
                   results.forEach(function(doc) {
                     commit(
                       "set_replied_requests_for_report_dec",
                       doc.data()
                     );
                   });
                   // set_replied_requests_for_report
           ...
           submit_request({ getters }) {
             ...
             for (
               let i = 0;
               i < businesses_being_submitted.length;
               i++
             ) {
               ...
               function() {
                 ...
                 uploadTask.snapshot.ref
                   ...
                   .then(function(downloadURL) {
                     ...
                     let user = {
                       business_name:
                         getters.business_signing_up.business_name,
